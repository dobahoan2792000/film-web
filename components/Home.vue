<template>
  ...
  <div class="flex flex-col items-center px-5 py-24 mx-auto">
    <h1 class="sm:text-3xl text-2xl font-medium title-font text-center text-gray-900 mb-20">Management Our Things
    </h1>
