<template>
	...
	<aside
		class="flex flex-col items-center text-gray-700 shadow h-full bg-blue-100 fixed top-0 left-0">
		<!-- Side Nav Bar-->
<!--
		<div class="">

			<nuxt-link to="/" class="h-16 px-6 flex justify-center items-center w-full">
