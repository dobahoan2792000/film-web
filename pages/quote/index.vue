<template>
  <div class="relative px-4 py-16 w-screen flex justify-center">
    <div class="absolute items-center justify-center hidden overflow-hidden md:flex left-0 top-0 w-full h-full">
    ...
    <div class="z-50">
        <div class="z-50 grid gap-5 sm:grid-cols-2 lg:grid-cols-4 h-auto">
